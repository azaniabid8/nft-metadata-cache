<p align="center">
  <b>nft-metadata-cache</b>
</p>

<p align="center">
  <sub>ipfs · erc-721 · grid</sub>
</p>

<p align="center">
  <code>.NET 10</code> &nbsp;·&nbsp; <code>MIT</code> &nbsp;·&nbsp; <code>NftCache</code> &nbsp;·&nbsp; <code>nftcache</code>
</p>
...
Local NFT metadata cache — ERC-721 grid, IPFS fetch, offline preview.

nft-metadata-cache is the util repo name collectors actually bookmark.
...
```bash
dotnet restore nft-metadata-cache.slnx
dotnet build nft-metadata-cache.slnx -c Release
dotnet test nft-metadata-cache.slnx -c Release
```
